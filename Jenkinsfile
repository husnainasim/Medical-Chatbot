pipeline {
    ...
    stages {
        ...
        stage('Build, Scan, and Push Docker Image to ECR') {
            steps {
                withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-token']]) { //same aws-token name as you mentioned in jenkins credentials in dashboard
                    script {
